...
export function wasm_bindgen__convert__closures__invoke2_mut__h25c97cc543b2b066(a: number, b: number, c: number, d: number): void;
export function wasm_bindgen__convert__closures__invoke0_mut__hb4be7aa337525a7e(a: number, b: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__h3ac3b9486c69da74(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__h78a15c5e840f70f9(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke0_mut__h74cd52cc39fd6202(a: number, b: number): void;
export function wasm_bindgen__convert__closures__invoke0_mut__ha24b37ccfc5a9aa6(a: number, b: number): void;
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h1b40db2a55ff9464(a: number, b: number, c: number): void;
